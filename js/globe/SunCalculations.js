define(["require", "exports", "./Common"], function (require, exports, Common) {
     ...
     */
    "use strict";
    var PI = Math.PI, sin = Math.sin, cos = Math.cos, asin = Math.asin, rad = PI / 180, e = rad * 23.439281, dayMs = 1000 * 60 * 60 * 24, J1970 = 2440588, J2000 = 2451545;
    ...
    var Calculator = (function () {
        function Calculator(currentDate) {
            this.currentDate = currentDate;
            var days = toDays(currentDate), sMA = solarMeanAnomaly(days);
            var today = new Date();
        ...
        Calculator.prototype.getDeclanation = function () {
            return declination(this.eclipticLng, 0);
        };
        Calculator.prototype.getRightAscension = function () {
...
//# sourceMappingURL=SunCalculations.js.map